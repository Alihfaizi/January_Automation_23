...
public class GoogleHomePage extends ReusableAnnotations {
    ...
    public void enterKeywordOnSearchField(String userValue){
        ReusableMethod_Logger_POM.sendKeysMethod(driver,searchField,userValue,logger,"Search Field");
    }//end of search method

    public void submitOnGoogleSearchButton(){
        ReusableMethod_Logger_POM.submitMethod(driver,searchButton,logger,"Search Search Button");
